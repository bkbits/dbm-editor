...
| `bash scripts/e2e-task36.sh`      | 字段约定与表编辑 E2E（25 项断言：逻辑删除约定设置/持久化、一键添加、勾选互斥转移、左右固定列吸附）                                               |
...
表编辑对话框的左右固定列（窄视口横向滚动时排序 / 字段名列吸附左侧、删除按钮吸附右侧）与逻辑删除字段标记：

| 表编辑 · 左右固定列（窄视口滚动吸附）                 | 表编辑 · 逻辑删除字段（一键添加 / 勾选互斥）          |
| ----------------------------------------------------- | ----------------------------------------------------- |
