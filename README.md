...
| `bash scripts/e2e/ai-agent.sh`       | E2E · AI 工具链域（146 项断言：pi 内核链路/53 工具注册/历史回放/参数校验重试/错误前缀回填/双工具串行/genCodeZip-genCodeReplace 链路/reload 四工具/AIApi 三协议对话/AI 设置工具/撤销链路/removeAll-resetDemo 危险确认/fetch/getTableRects 画布矩形/skill-github 真实网络技能加载/点击选项/请求失败重试/思考块贴底三态/技能/任务清单/85% 自动压缩/用量统计/轮数上限） |
...
AGENT 新工具（getTableRects 表卡片矩形读取 / skill-github GitHub 技能文档加载，见 `scripts/e2e/ai-agent.sh` 第 19/20 节）：
